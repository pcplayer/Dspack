...
interface
uses
  Windows, Classes, SysUtils, Messages, Graphics, Forms, Controls, ActiveX, Winapi.DirectShow9,
  Winapi.DirectDraw, DSUtil, ComCtrls, Winapi.MMSystem, Math, Consts, ExtCtrls,
  MultiMon, Dialogs, Registry, SyncObjs, Winapi.Direct3D9, Winapi.WMF9;
...
// *****************************************************************************
  ...
  public
    ...
    property VMR9: IVMRWindowlessControl9 read FWindowLess;   //add by pcplayer
    property VideoWindow: IVideoWindow read FVideoWindow;     //add by pcplayer
  published
...
// *****************************************************************************
  ...
  var
    hr: HRESULT;
    Event: Longint;
    Param1, Param2: LONG_PTR;   // LongInt; // ;
  begin
    if assigned(FMediaEventEx) then
    begin
      hr := FMediaEventEx.GetEvent(Event, Param1, Param2, LONG_PTR(0));
      while (hr = S_OK) do
      begin
  ...
  var
    ...
    tc      : TDsPackDVDTimecode; //TDVDTimeCode;
    frate   : integer;
