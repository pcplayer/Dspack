...
interface
uses Windows, SysUtils, Classes, Math, ActiveX, VCL.Forms, Messages, VCL.Controls,
  Winapi.DirectShow9, {dialogs,} ComObj, Winapi.mmsystem, DSUtil;
...
function TBCBaseInputPin.ReceiveMultiple(pSamples: PIMediaSampleArray; nSamples: Longint;
        out nSamplesProcessed: Longint): HRESULT;
type
...
//    dec(nSamples)
//  end;                   //从D7的版本改为支持 XE3 的版本.XE3 里面,接口函数声明变了,所以代码变了.
      ...
      begin
        ...
        if (Source.GetMediaType(MediaType) = S_OK) then
          begin
            ...
            result.SetMediaType(MediaType);  //by pcplayer for  XE3
            DeleteMediaType(MediaType);
          end;
